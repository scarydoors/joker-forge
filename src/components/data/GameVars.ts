        ...
        variables: [
          {
            ...
            code: "(function() local min = 14; for _, card in ipairs(G.hand.cards) do if card.base.id < min then min = card.base.id end end; return min end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "hand_analysis",
            code: "(function() local max = 0; for _, card in ipairs(G.hand.cards) do if card.base.id > max then max = card.base.id end end; return max end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 2 then count = count + 1 end end; return count end)()",
          },
          {
            id: "threes_in_deck",
            label: "3s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 3 then count = count + 1 end end; return count end)()",
          },
          {
            id: "fours_in_deck",
            label: "4s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 4 then count = count + 1 end end; return count end)()",
          },
          {
            id: "fives_in_deck",
            label: "5s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 5 then count = count + 1 end end; return count end)()",
          },
          {
            id: "sixes_in_deck",
            label: "6s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 6 then count = count + 1 end end; return count end)()",
          },
          {
            id: "sevens_in_deck",
            label: "7s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 7 then count = count + 1 end end; return count end)()",
          },
          {
            id: "eights_in_deck",
            label: "8s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 8 then count = count + 1 end end; return count end)()",
          },
          {
            id: "nines_in_deck",
            label: "9s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 9 then count = count + 1 end end; return count end)()",
          },
          {
            id: "tens_in_deck",
            label: "10s in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 10 then count = count + 1 end end; return count end)()",
          },
          {
            id: "jacks_in_deck",
            label: "Jacks in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 11 then count = count + 1 end end; return count end)()",
          },
          {
            id: "queens_in_deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 12 then count = count + 1 end end; return count end)()",
          },
          {
            id: "kings_in_deck",
            label: "Kings in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 13 then count = count + 1 end end; return count end)()",
          },
          {
            id: "aces_in_deck",
            label: "Aces in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_ranks",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.id == 14 then count = count + 1 end end; return count end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.suit == 'Spades' then count = count + 1 end end; return count end)()",
          },
          {
            id: "hearts_in_deck",
            ...
            category: "deck",
            subcategory: "deck_composition_suits",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.suit == 'Hearts' then count = count + 1 end end; return count end)()",
          },
          {
            id: "diamonds_in_deck",
            ...
            category: "deck",
            subcategory: "deck_composition_suits",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.suit == 'Diamonds' then count = count + 1 end end; return count end)()",
          },
          {
            id: "clubs_in_deck",
            label: "Clubs in Deck",
            ...
            category: "deck",
            subcategory: "deck_composition_suits",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.base.suit == 'Clubs' then count = count + 1 end end; return count end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_bonus') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_mult') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_wild') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_glass') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_steel') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_stone') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_gold') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if SMODS.has_enhancement(card, 'm_lucky') then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_enhancements",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if next(SMODS.get_enhancements(card)) then count = count + 1 end end; return count end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.edition and card.edition.foil then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_editions",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.edition and card.edition.holo then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_editions",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.edition and card.edition.polychrome then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_editions",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.edition and card.edition.negative then count = count + 1 end end; return count end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.seal == 'Gold' then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_seals",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.seal == 'Red' then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_seals",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.seal == 'Blue' then count = count + 1 end end; return count end)()",
          },
          {
            ...
            category: "deck",
            subcategory: "deck_composition_seals",
            code: "(function() local count = 0; for _, card in ipairs(G.playing_cards) do if card.seal == 'Purple' then count = count + 1 end end; return count end)()",
          },
        ],
      },
    ],
        ...
        variables: [
          {
            ...
            code: "(function() local count = 0; for _, joker in ipairs(G.jokers.cards) do if joker.config.center.rarity == 1 then count = count + 1 end end; return count end)()",
          },
          {
            id: "uncommon_jokers",
            ...
            category: "jokers",
            subcategory: "joker_rarities",
            code: "(function() local count = 0; for _, joker in ipairs(G.jokers.cards) do if joker.config.center.rarity == 2 then count = count + 1 end end; return count end)()",
          },
          {
            id: "rare_jokers",
            label: "Rare Jokers",
            ...
            category: "jokers",
            subcategory: "joker_rarities",
            code: "(function() local count = 0; for _, joker in ipairs(G.jokers.cards) do if joker.config.center.rarity == 3 then count = count + 1 end end; return count end)()",
          },
          {
            id: "legendary_jokers",
            ...
            category: "jokers",
            subcategory: "joker_rarities",
            code: "(function() local count = 0; for _, joker in ipairs(G.jokers.cards) do if joker.config.center.rarity == 4 then count = count + 1 end end; return count end)()",
          },
        ],
      },
      {
        ...
        variables: [
          {
            ...
            code: "(function() local total = 0; for _, joker in ipairs(G.jokers.cards) do if joker ~= card then total = total + joker.sell_cost end end; return total end)()",
          },
          {
            ...
            category: "jokers",
            subcategory: "joker_economics",
            code: "(function() local total = 0; for _, joker in ipairs(G.jokers.cards) do total = total + joker.sell_cost end; return total end)()",
          },
        ],
      },
    ],
        ...
        variables: [
          {
            ...
            code: "(G.hand.cards[1] and G.hand.cards[1].base.id or 0)",
          },
          {
            ...
            category: "special",
            subcategory: "hand_position",
            code: "(G.hand.cards[#G.hand.cards] and G.hand.cards[#G.hand.cards].base.id or 0)",
          },
          {
