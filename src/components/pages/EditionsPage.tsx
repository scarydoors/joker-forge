  ...
  return (
    <div className="p-8">
      <div className="flex items-center gap-3 mb-6">
        <SparklesIcon className="h-8 w-8 text-mint" />
      ...
      <div className="bg-black-dark border-2 border-black-lighter rounded-lg p-6">
        <div className="text-center py-12">
          <SparklesIcon className="h-16 w-16 text-white-darker mx-auto mb-4 opacity-50" />
          <h2 className="text-xl text-white-light font-light mb-2">
            Edition Editor
          </h2>
          <p className="text-white-darker text-sm max-w-md mx-auto">
            Create custom card editions with unique visual effects and gameplay
            modifications beyond the standard Foil, Holographic, Polychrome, and
            Negative editions.
          </p>
